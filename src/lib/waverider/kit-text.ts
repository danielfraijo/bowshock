...
export function readmeFor(built: BuiltVehicle): string {
  ...
  return `BOWSHOCK — waverider CFD kit
================================
...
CFD notes
---------
- Sharp leading edges are Euler-friendly. For Navier–Stokes set a finite
  LE radius in the generator (or blunt in the mesher) or heat flux will
  spike. A radius of ~0.1–0.3% of length is a common starting point.
